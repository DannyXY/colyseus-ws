                ...
                (function () {
                    (n._nextId = 0),
                        ...
                        (n.isPlainObject = function (e) {
                            return (
                                "object" == typeof e && e.constructor === Object
                            );
                        }),
        ...
        function (e, t) {
            ...
            (e.exports = n),
                ...
                (n.cross3 = function (e, t, n) {
                    return (
                        (t.x - e.x) * (n.y - e.y) - (t.y - e.y) * (n.x - e.x)
                    );
                }),
                (n.add = function (e, t, n) {
                    return (
                        n || (n = {}), (n.x = e.x + t.x), (n.y = e.y + t.y), n
                    );
                }),
                ...
                (i.chamfer = function (e, t, n, i, a) {
                    ...
                    for (var s = [], l = 0; l < e.length; l++) {
                        ...
                        if (0 !== p) {
                            ...
                            for (
                                var b = Math.acos(o.dot(f, v)) / h, S = 0;
                                S < h;
                                S++
                            )
        ...
        function (e, t, n) {
            ...
            (i.create = function (e) {
                ...
                (i.removeBodyAt = function (e, t) {
                    return (
                        e.bodies.splice(t, 1), i.setModified(e, !0, !0, !1), e
                    );
                }),
                (i.addConstraint = function (e, t) {
                    return (
                        e.constraints.push(t), i.setModified(e, !0, !0, !1), e
                    );
                }),
        ...
        function (e, t, n) {
            ...
            (o = []),
                ...
                (i._findSupports = function (e, t, n, i) {
                    ...
                    return (
                        (m =
                            v * (p - (s = u[(d + r.index - 1) % d]).x) +
                            y * (f - s.y)),
                        v * (p - (a = u[(r.index + 1) % d]).x) + y * (f - a.y) <
                        m
                            ? ((o[0] = r), (o[1] = a), o)
                            : ((o[0] = r), (o[1] = s), o)
                    );
        ...
        function (e, t, n) {
            ...
            (i._warming = 0.4),
                ...
                (i.create = function (e) {
                    ...
                    var n = t.bodyA
                            ? r.add(t.bodyA.position, t.pointA)
                            : t.pointA,
                        i = t.bodyB
                            ? r.add(t.bodyB.position, t.pointB)
                            : t.pointB,
                ...
                (i.solveAll = function (e, t) {
                    ...
                    for (n = 0; n < e.length; n += 1)
                        (r =
                            !(o = e[n]).bodyA || (o.bodyA && o.bodyA.isStatic)),
                            (a = !o.bodyB || (o.bodyB && o.bodyB.isStatic)),
                            r || a || i.solve(e[n], t);
                }),
                (i.solve = function (e, t) {
                    ...
                    if (n || o) {
                        n &&
                            !n.isStatic &&
                            (r.rotate(a, n.angle - e.angleA, a),
                            (e.angleA = n.angle)),
                            o &&
                                !o.isStatic &&
                                (r.rotate(s, o.angle - e.angleB, s),
                                (e.angleB = o.angle));
                        var l = a,
                            c = s;
                        if (
        ...
        function (e, t, n) {
            ...
            (i.create = function (e) {
                ...
                return (
                    ...
                    (t.pixelRatio =
                        parseInt(
                            t.element.getAttribute("data-pixel-ratio"),
                            10
                        ) || 1),
                    (t.sourceEvents = {
                        mousemove: null,
                    ...
                    (t.mousemove = function (e) {
                        ...
                        e.changedTouches &&
                            ...
                            (t.absolute.y = n.y),
                            (t.position.x =
                                t.absolute.x * t.scale.x + t.offset.x),
                            (t.position.y =
                ...
                (i._getRelativeMousePosition = function (e, t, n) {
                    ...
                    return (
                              ...
                              (o = e.pageY - r.top - l)),
                        {
                            x:
                                i /
                                ((t.clientWidth / (t.width || t.clientWidth)) *
                                    n),
                            y:
                                o /
                                ((t.clientHeight /
            ...
            !(function () {
                ...
                "undefined" != typeof window &&
                    ...
                    (i.create = function (e) {
                        ...
                        return (
                            ...
                            (n.canvas =
                                n.canvas ||
                                d(n.options.width, n.options.height)),
                    ...
                    (i.status = function (e, t, n, i, r, a, s, l, c) {
                        ...
                        for (var u = 0; u < i; u += 1)
                            e.lineTo(
                                ...
                                n +
                                    7 -
                                    (u < a ? r * o.clamp(0.4 * c(u), -2, 2) : 0)
                            );
                        e.stroke(),
                            (e.fillStyle =
                                "hsl(" +
                                o.clamp(25 + 95 * l, 0, 120) +
                                ",100%,60%)"),
                    ...
                    (i.bodyVelocity = function (e, t, n) {
                        ...
                        for (var o = 0; o < t.length; o++) {
                            ...
                            r.render.visible &&
                                ...
                                i.lineTo(
                                    r.position.x +
                                        2 * (r.position.x - r.positionPrev.x),
                                    r.position.y +
                                        2 * (r.position.y - r.positionPrev.y)
                                ));
                        }
                        (i.lineWidth = 3),
                ...
                var n = function (e, t) {
                        ...
                        (o.delta = t - o.lastTime || i._goodDelta),
                            ...
                            (o.deltaHistory.length = Math.min(
                                o.deltaHistory.length,
                                r
                            )),
                            ...
                            o.timestampElapsedHistory.unshift(
                                o.timestampElapsed
                            ),
                            ...
                            o.engineElapsedHistory.unshift(
                                n.timing.lastElapsed
                            ),
                    ...
                    f = function (e, t) {
                        ...
                        return (
                            n ||
                            (((n = e.textures[t] = new Image()).src = t), n)
                        );
                    },
                    v = function (e, t) {
                        var n = t;
            ...
            (i.create = function (e) {
                ...
                (i.update = function (e, t, n) {
                    ...
                    for (
                        s.update(m, w, x),
                            e.enableSleeping &&
                                o.afterCollisions(m.list, g.timeScale),
            ...
            (i.create = function (e) {
                ...
                (i.update = function (e, t, n) {
                    var i,
                        ...
                        v = e.collisionActive;
                    for (
                        p.length = 0, f.length = 0, v.length = 0, s = 0;
                        s < c;
                        s++
                    )
                                ...
                                for (a = y.startCol; a <= y.endCol; a++)
                                    for (s = y.startRow; s <= y.endRow; s++) {
                                        ...
                                        !m &&
                                            ...
                                            g &&
                                            l &&
                                            i._bucketRemoveBody(e, l, f),
                                            (f.region === v ||
                                                (m && !g) ||
                                                o) &&
                                                (l ||
                                                    (l = i._createBucket(d, c)),
        ...
        function (e, t, n) {
            ...
            (i.create = function (e, t) {
                ...
                (i.update = function (e, t) {
                    ...
                    if (0 === n.button) {
                        if (i.bodyB)
                            r.set(i.bodyB, !1), (i.pointA = n.position);
                        else
                            for (var c = 0; c < t.length; c++)
                                if (
                                    ...
                                    for (
                                        ...
                                        var d = a.parts[u];
                                        if (
                                            o.contains(d.vertices, n.position)
                                        ) {
                                            (i.pointA = n.position),
                                                (i.bodyB = e.body = a),
                                                (i.pointB = {
                    ...
                    for (var n = [], i = 0; i < e.length; i++) {
                        ...
                        if (a.contains(o.bounds, t))
                            for (
                                ...
                                var s = o.parts[r];
                                if (
                                    a.contains(s.bounds, t) &&
                                    l.contains(s.vertices, t)
                                ) {
                                    n.push(o);
                                    break;
                                }
                    ...
                    for (
                        ...
                        if (/[MLHVCSQTA]/.test(f))
                            ...
                            switch (
                                ...
                                case "m":
                                    s.replaceItem(
                                        e.createSVGPathSegMovetoAbs(l, c),
                                        d
                                    );
                                    break;
                                case "l":
                                    s.replaceItem(
                                        e.createSVGPathSegLinetoAbs(l, c),
                                        d
                                    );
                                    break;
                                case "h":
